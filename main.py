...
class KostalEMQuery:
    ...
    def __init__(self, inverter_ip, inverter_port):
    ...
    def get_result(self, ):
        return json.dumps([{'name': t[0], 'register': t[1], 'value': t[2], 'ts': t[3]} for t in self._results], indent=2)
    ...
    def run(self):
        ...
        for addr, name, multiplier in [
            ...
            self._results.append(self._read_u32(addr, name, multiplier))
        ...
        for addr, name in [
            ...
            self._results.append(self._read_int32(addr, name, 0.001))
        ...
        for addr, name in [
            ...
            self._results.append(self._read_uint64(addr, name, 0.1))

        self._results.append(self._read_u16_1(8192, 'ManufacturerID', 1))


if __name__ == "__main__":
    kemq = KostalEMQuery("192.168.178.99", "502")
    kemq.run()
    result = kemq.get_result()
    print(result)
    kemq.terminate()
